class PizzaDelivery:
    ...
    def make_order(self):
        self.ordered = True
        curr_ingredient = ", ".join(f'{i}: {v}' for i, v in self.ingredients.items())
        return f"You've ordered pizza {self.name} prepared with {curr_ingredient} and the price will be {self.price}lv."
